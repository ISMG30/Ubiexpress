<?php
   ...
   include_once 'ModeloE.php';
    ...
    foreach($datosclientes as $cliente){
           ...
           /*$insertar = "INSERT INTO ubiexpress(id_Unidad, Unidad, combustible, km) VALUES ('".$cliente['id']."','".$cliente['user']."','".$cliente['com']."','".$cliente['km']."')";
    ...
    class json extends ModeloE {
      ...
      private $modelo;
       ...
       function Insercion()
        {
          $modelo = new ModeloE();
           $json ='[{"id":"6","user":"C. ROJA SN-75-862","com":"49.5","km":"28140"},
                    {"id":7,"user":"C. ROJA SN-75-866","com":"48.5","km":"29569"},
                    {"id":"8","user":"TRAILER CASCADIA SN-88-974","com":"220","km":"39760"},
                    {"id":"9","user":"TRAILER CASCADIA SN-99-983","com":"120","km":"23585"},
                    {"id":"10","user":"C. ROJA SN-75-862","com":"49.5","km":"28140"}]';
